## Introduction
HotSeconds is a remote hot deployment plugin for Java, including HotSecondsClient and HotSecondsServer. In theory, it can hot reloading any file (java, xml, html, css, js, etc.), and also supports hot update of common frameworks (Spring, MyBatis). It can save a lot of time in packaging->deployment->startup. <br>
