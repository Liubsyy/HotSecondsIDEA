...
You can also manually go to [libjvm.so](https://github.com/thanple/HotSecondsIDEA/blob/master/install/dcevm_download.md) to find the corresponding version to download, and put it under ./lib in the decompression directory after downloading.
