...
### 1.安装服务器包 ###
【Linux】下载HotSecondsServer.zip到本地解压，然后去[libjvm.so](https://github.com/thanple/HotSecondsIDEA/blob/master/install/libjvm_so.md)找对应的jdk版本下载完后无需改名直接放到解压后目录的./lib下，最后然后上传到服务器(记目录为path1)，执行sh install.sh<br>
