...
支持系统：Linux,MacOS(M1芯片暂不支持)和Windows
...
## 快速入门
>1.安装完后，点击Debug旁边的按钮启动连接远程服务器，2023版本最新的UI可以选择Run菜单->HotSeconds Start/Stop(最新版UI建议设置快捷键).
>
>2.打开java文件，右键选择Hot swap this file to remote可热部署当前文件，左侧工程中的文件也可以右键选择热部署.
>
>3.针对java文件右键，还可以选择Remote compilation and Hot swap，即远程编译并热部署.
>
...
当然如果你需要这么做，可以把“Server端安装”中的第1步和第2步省了，去[dcevm](https://github.com/dcevm/dcevm/releases) 找到你的JDK版本的jar包(支持macOS, Linux and Windows)，下载下来后执行sudo java -jar DCEVM-light-8u-install.jar安装后，然后再执行第3步和第4步。<br><br>
