...
## 快速入门
- 安装完后，点击Debug旁边的按钮启动连接远程服务器，2023版本最新的UI可以选择Run菜单->HotSeconds Start/Stop(最新版UI建议设置快捷键).
...
- HotSecondsClient控制台：在普通控制台旁边有一个插件专用HotSecondsClient控制台，里面打印了一些热部署信息，以及远程执行函数返回的字符串.
