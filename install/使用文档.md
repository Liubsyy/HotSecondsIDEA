...
**有些版本安装会报错，这个在1.6.3版本已经修复了这个问题了，插件市场还在审核中(估计明天6-26会上架)，可以去https://github.com/thanple/HotSecondsIDEA/releases/download/client_fast_track/HotSecondsClient-1.6.3.jar 下载这个版本，直接拖进idea就行，或者用Plugins->Install Plugin from Disk安装**
