...
也可以手动去[libjvm.so](https://github.com/thanple/HotSecondsIDEA/releases/tag/libjvm_so)找对应的版本下载，下载完后放到解压后目录的/lib下。<br><br>
...
Tomcat项目：Tomcat7及以下填WebappClassLoader，Tomcat8及其以上填ParallelWebappClassLoader
SpringBoot项目：LaunchedURLClassLoader
